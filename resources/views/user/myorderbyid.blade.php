        ...
        <div class="py-5">
            <div class="py-5 container d-flex flex-column gap-4 gap-lg-5 min-vh-100">
                <div class="d-flex flex-column gap-3">
                    <a href="{{ route('myorder') }}" class="btn btn-dark d-flex justify-content-center align-items-center p-2 p-sm-3" style="width: fit-content;">
                ...
                <div class="d-flex flex-column gap-4 bg-white p-4 p-sm-5 rounded">
                ...
                <div class="d-flex flex-column bg-white p-4 p-lg-5 gap-5 rounded">
